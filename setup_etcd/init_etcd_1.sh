...
ETCD_LISTEN_PEER_URLS="https://$WORKER1:2380"
ETCD_LISTEN_CLIENT_URLS="https://$WORKER1:2379"

#[cluster]
ETCD_INITIAL_ADVERTISE_PEER_URLS="https://$WORKER1:2380"
ETCD_INITIAL_CLUSTER_TOKEN="etcd-cluster"
ETCD_ADVERTISE_CLIENT_URLS="https://$WORKER1:2379"
EOF
